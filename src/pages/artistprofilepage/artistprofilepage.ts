...
export class ArtistprofilepagePage {
  ...
  ionViewDidLoad() {
    ...
    if (this.topid == 1) {
      console.log(
        this.rcentdata,
        "-topid--",
        this.rcentdata[this.id].artist_id
      );
  ...
  artitsload() {
    ...
    Observable.of(this.loaderitem)
      .flatMap(() => this.security.artistcharts(this.artistid))
      .subscribe((data) => {
  ...
  recentcharts(infiniteScroll?) {
    ...
    Observable.of(this.loadingrecentdata)
      .flatMap(() =>
        this.security.artistprofilerecentchats(
          this.page,
          this.catid,
          this.artistid
        )
      ...
      .subscribe((data) => {
        ...
        console.log("user_banner" + data.media[0].Users.user_banner);
        console.log(
          "user_display_name" + data.media[0].Users.user_display_name
        );
  ...
  getfollowing() {
    Observable.of(null)
      .flatMap(() => this.security.getfollowing(this.artistid))
      .subscribe((data) => {
  ...
  getfollow() {
    Observable.of(null)
      .flatMap(() => this.security.getfollow(this.artistid))
      .subscribe((data) => {
