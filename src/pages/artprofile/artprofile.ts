...
export class ArtprofilePage {
  ...
  loadcat() {
    Observable.of(null)
      .flatMap(() => this.security.getcategory())
      .subscribe((data) => {
        localStorage["category"] = JSON.stringify(data.categories);
      });
    Observable.of(null)
      .flatMap(() => this.security.getcategories())
      .subscribe((data) => {
  ...
  movetofollowers(id) {
    ...
    if (id == 1) {
      Observable.of(null)
        .flatMap(() => this.security.getfollow(""))
        .subscribe((data) => {
          console.log("datausers", data.list);
          console.log("hii");
          this.followersdata = data.list;
          ...
          console.log("followersdata", this.followersdata);
          let popover = this.modalCtrl.create(FollowersPagepPage, {
      ...
      Observable.of(null)
        .flatMap(() => this.security.getfollowing(""))
        .subscribe((data) => {
          console.log("followingusers", data.list);
  ...
  usercharts() {
    ...
    Observable.of(this.loaderitem)
      .flatMap(() => this.security.charts(this.catid))
      .subscribe((data) => {
  ...
  recentcharts(infiniteScroll?) {
    ...
    Observable.of(null)
      .flatMap(() => this.security.artistprofilerecent(this.page, this.catid))
      .subscribe((data) => {
        // this.following=localStorage['following']
        // this.loadingrecentdata=false
  ...
  openstar(usermediaid) {
    ...
    if (usermediaid) {
      ...
      modal.present();
      Observable.of(null)
        .flatMap(() => this.security.starmedia(this.rate, usermediaid))
        .subscribe((data) => {});
    }
  }
  navigatetocomment1(i) {
    ...
    console.log(
      "category_image_url",
      this.profilerecentcharts[i].category_image_url
    );
  ...
  changetype() {
    ...
    Observable.of(loading)
      ...
      .flatMap(() => this.security.changeusertype())
      .subscribe((data) => {
        loading.dismiss();
      ...
      buttons: [
        {
          ...
          handler: (data) => {
            ...
            Observable.of(loading)
              .flatMap((loading) => loading.present())
              .flatMap(() => this.security.getDeleteMedia(UsrMediaID))
              .subscribe((data) => {
                loading.dismiss();
