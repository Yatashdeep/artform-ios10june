...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(829);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic3_star_rating__ = __webpack_require__(392);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__categorytabpage_categorytabpage__ = __webpack_require__(812);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__viewvideoplay_viewvideoplay__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_security_security__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rxjs__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_dashboardservice_dashboardservice__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__viewvideotopperformers_viewvideotopperformers__ = __webpack_require__(180);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardPage = (function () {
    function DashboardPage(events, dashboard, service, loadingCtrl, 
        // private nativePageTransitions: NativePageTransitions,
        popoverCtrl, modalCtrl, navCtrl, navParams) {
        var _this = this;
        this.events = events;
    ...
    DashboardPage.prototype.loaddata = function (infiniteScroll) {
        ...
        this.countload++;
        __WEBPACK_IMPORTED_MODULE_11_rxjs__["Observable"].of(this.loadingdata)
            .flatMap(function () {
    ...
    DashboardPage.prototype.followartist = function (artist_id, user_display_name) {
        ...
        if (this.user_display_name == user_display_name) {
            ...
            __WEBPACK_IMPORTED_MODULE_11_rxjs__["Observable"].of(null)
    ...
    DashboardPage.prototype.viewvideo = function (id) {
        var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__viewvideoplay_viewvideoplay__["a" /* ViewvideoplayPage */], {
    ...
    DashboardPage.prototype.viewvideotop = function (id) {
        var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_13__viewvideotopperformers_viewvideotopperformers__["a" /* ViewvideotopperformersPage */], {
